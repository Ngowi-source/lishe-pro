...
new ScrollMagic.Scene({
    ...
    .setTween(TweenMax.from("#whoAreWe h1", 0.6, {x: -600, autoAlpha: 0.0, ease: Back.easeIn}))
    .addTo(controller);
...
new ScrollMagic.Scene({
    ...
    .setTween(TweenMax.from("#blog .card", 1, {x: -350, scale: 0.6, autoAlpha: 0.0, ease: Power0.easeIn}))
    .addTo(controller);