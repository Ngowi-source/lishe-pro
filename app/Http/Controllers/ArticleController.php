...
class ArticleController extends Controller
{
    ...
    public function index()
    {
        ...
        $archives = Article::selectRaw('YYYY(created_at) year, monthname(created_at) month, count(*) published')->groupBy('year', 'month')->orderByRaw('min(created_at) desc')->get()->toArray();
