    ...
    <div id="blogWrapper">
        ...
        <div id="blogBod">
            ...
            @foreach($articles as $article)
                ...
                <span class="articleBod">@if(strlen(preg_replace('/<img(.*)>/', '', $article->body))>400){!! substr(preg_replace('/<img(.*)>/', '', $article->body),0,400) !!}... <span class="readMore"><a href="/blog/{{str_replace(' ','-',$article->title)}}"><i>Read More</i></a></span> @else{!! preg_replace('/<img(.*)>/', '', $articles->body) !!}@endif</span><br />
